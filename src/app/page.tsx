...
import { HomepageCanvas } from '@/components/features/home/HomepageCanvas'
    ...
    <div className="min-h-screen relative">
      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <main className="flex-1 flex flex-col">
          ...
          {/* Featured Projects (FIRED section - appears on scroll)}}
          {featured.length > 0 && (
            <motion.section
              id="fired"
              initial={{ opacity: 0, y: 20 }}
            ...
            >
              <div className="max-w-6xl mx-auto w-full px-6 py-16">
                <div className="flex items-center gap-2 mb-8">
                  ...
                  <h2 className="text-xl font-bold text-text">FIRED — Showcased Projects</h2>
                </div>
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                  {featured.slice(0, 6).map((project) => (
                    <Link key={project.id} href={`/projects/${project.id}`}>
                      <div className="rounded-xl border border-border bg-surface p-5 hover:border-accent/20 transition-colors h-full group">
